...
class Widget1():
    ...
    def gui(self, parent):
        ...
        self.soffitIndicator = Label(self.ta1, anchor='e', text = "", bg = "#333333", fg = "#FFFFFF", font = tkinter.font.Font(family = font, size = 12, weight = 'bold'), cursor = "arrow", state = "normal")
        ...
        self.cutIndicator = Label(self.ta1, text = "", bg = "#333333", fg = "#FFFFFF", anchor='e', font = tkinter.font.Font(family = font, size = 12, weight = 'bold'), cursor = "arrow", state = "normal")
